  ...
  return (
    <div className='pt-25'>
        <div className='flex justify-center items-center'>
            <h1 className='text-4xl text-gray-950 font-semibold'> IP PRODUCT</h1>
        </div>
        <div className='flex flex-row w-full gap-5 items-center pl-10 pt-20 '>
            {productList.map((product)=>(
                <span 
                className={`text-xl  font-semibold cursor-pointer ${activeProduct === product.id ? 'text-gray-900':'text-gray-500'}`}
